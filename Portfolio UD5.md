...
2. ¿Por qué crees que el TreeSet ordena los elementos alfabéticamente?

	Porque sigue un orden natural de los elementos.

3. ¿Qué Set elimina los elementos duplicados? ¿Por qué ocurre esto?
...
3. Introducimos un método para imprimir cada conjunto con un iterador y probamos el método con 	los tres tipos de Set y explica:
